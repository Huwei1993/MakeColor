package com.shayne.makecolor.Activity;

import com.google.zxing.WriterException;
import com.shayne.makecolor.R;
import com.shayne.makecolor.karics.library.zxing.android.CaptureActivity;
import com.shayne.makecolor.karics.library.zxing.encode.CodeCreator;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scanner.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(ErWeiMa.this,
